...
public interface ChatUserPersistence extends BasePersistence<ChatUser> {
	...
	*/
	public ChatUser findByPseudo(java.lang.String pseudo)
	...
	*/
	public ChatUser fetchByPseudo(java.lang.String pseudo);
	...
	*/
	public ChatUser removeByPseudo(java.lang.String pseudo)
		throws NoSuchChatUserException;
	...
	*/
	public int countByPseudo(java.lang.String pseudo);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, ChatUser> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<ChatUser> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ChatUser> orderByComparator);
